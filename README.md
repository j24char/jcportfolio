...
jcportfolio is my personal portfolio web app built using the React library. It provides a way to showcase my work, skills, and achievements in a professional and visually appealing way. 
